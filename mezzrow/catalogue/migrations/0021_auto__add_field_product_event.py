...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.event'
        db.add_column(u'catalogue_product', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='products', null=True, to=orm['events.Event']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.event'
        db.delete_column(u'catalogue_product', 'event_id')
