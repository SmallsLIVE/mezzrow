...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.set_time'
        db.delete_column(u'catalogue_product', 'set_time')

        # Adding field 'Product.set'
        db.add_column(u'catalogue_product', 'set',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.set_time'
        db.add_column(u'catalogue_product', 'set_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Deleting field 'Product.set'
        db.delete_column(u'catalogue_product', 'set')
