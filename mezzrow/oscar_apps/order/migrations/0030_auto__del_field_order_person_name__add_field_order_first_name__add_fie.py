...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.person_name'
        db.delete_column(u'order_order', 'person_name')

        # Adding field 'Order.first_name'
        db.add_column(u'order_order', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)

        # Adding field 'Order.last_name'
        db.add_column(u'order_order', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.person_name'
        db.add_column(u'order_order', 'person_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)

        # Deleting field 'Order.first_name'
        db.delete_column(u'order_order', 'first_name')

        # Deleting field 'Order.last_name'
        db.delete_column(u'order_order', 'last_name')
    ...
    models = {
        ...
        u'basket.basket': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'baskets'", 'null': 'True', 'to': u"orm['users.SmallsUser']"}),
        ...
        u'catalogue.product': {
            'Meta': {'ordering': "['id', 'set', 'title']", 'object_name': 'Product'},
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'products'", 'null': 'True', 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'set': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255'}),
        ...
        u'events.event': {
            ...
            'performers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'events'", 'symmetrical': 'False', 'through': u"orm['events.GigPlayed']", 'to': u"orm['artists.Artist']"}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '150', 'blank': 'True'}),
        ...
        u'events.gigplayed': {
            'Meta': {'ordering': "['event', 'sort_order', 'is_leader']", 'object_name': 'GigPlayed'},
        ...
        u'order.order': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'orders'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['users.SmallsUser']"})
        },
        ...
        u'order.ordernote': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.SmallsUser']", 'null': 'True'})
        },
        ...
        u'partner.partner': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'partners'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['users.SmallsUser']"})
        },
